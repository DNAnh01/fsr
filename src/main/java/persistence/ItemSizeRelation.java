...
/*
 * Role: Entity
 * Mapping with table ChiTietMatHang
...
public class ItemSizeRelation {
	...
	public ItemSizeRelation(Id id, String image, Double salesPrice, Double buyPrice, Integer amount, Item item,
			Size size) {
		this.id = id;
		this.image = image;
		this.salesPrice = salesPrice;
	...
	// Nested class
	@Embeddable // nhúng Id trong ItemSizeRelation
	public static class Id implements Serializable{
		...
		public boolean equals(Object obj) {
			...
			return getItemId().equals(that.getItemId()) && getSizeId().equals(that.getSizeId());
		}
