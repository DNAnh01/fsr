...
public class HibernateItemGroupDao extends AbstractHibernateDao implements ItemGroupDao {
	...
	// private static final String JPQL_SELECT_ALL_ITEM_GROUPS = "SELECT ig FROM ItemGroup ig";
	// Option 1:
	/*
	public List<ItemGroup> getAll() {
		...
		return openSession()
				.createNativeQuery(NQ_SELECT_ALL_ITEM_GROUPS, ItemGroup.class)
				.getResultList();
	}
	*/
	// Option 2:
	/*
	public List<ItemGroup> getAll() {
		Query<ItemGroup> query = openSession().createQuery(JPQL_SELECT_ALL_ITEM_GROUPS, ItemGroup.class);
	...
	*/
	...
	public void secondLevelCache() {
		...
		clearRegionCache(ItemGroup.class);
		doTask(1);
